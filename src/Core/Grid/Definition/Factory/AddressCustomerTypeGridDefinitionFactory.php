...
namespace cdigruttola\Module\Einvoice\Core\Grid\Definition\Factory;
...
final class AddressCustomerTypeGridDefinitionFactory extends AbstractFilterableGridDefinitionFactory
{
    ...
    {
        return $this->trans('Address Customer Type', [], 'Modules.Einvoice.Einvoice');
    }
    ...
    protected function getColumns()
    {
        $columns = (new ColumnCollection())
            ...
            ->add((new DataColumn('name'))
                ->setName($this->trans('Customer Type', [], 'Modules.Einvoice.Einvoice'))
                ->setOptions([
                    'field' => 'name'
                ])
            )
