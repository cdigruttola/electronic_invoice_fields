 ...
 * @internal
 */
final class ToggleNeedInvoiceAddressCustomerTypeHandler extends AbstractAddressCustomerTypeHandler implements ToggleNeedInvoiceAddressCustomerTypeHandlerInterface
{
    /**
     * {@inheritdoc}
     *
