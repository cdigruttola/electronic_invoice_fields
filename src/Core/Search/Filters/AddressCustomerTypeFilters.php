...
namespace cdigruttola\Module\Electronicinvoicefields\Core\Search\Filters;
 ...
 */
final class AddressCustomerTypeFilters extends Filters
{
    /** @var string */
    protected $filterId = AddressCustomerTypeGridDefinitionFactory::GRID_ID;
